...
class LeasesControllerTest < ActionController::TestCase
  ...
  test "should create lease" do
    assert_difference('Lease.count') do
      post :create, lease: { end_date: @lease.end_date, rent: @lease.rent, start_date: @lease.start_date, unit_id: @lease.unit_id }
    end
  ...
  test "should update lease" do
    put :update, id: @lease, lease: { end_date: @lease.end_date, rent: @lease.rent, start_date: @lease.start_date, unit_id: @lease.unit_id }
    assert_redirected_to lease_path(assigns(:lease))
  end
